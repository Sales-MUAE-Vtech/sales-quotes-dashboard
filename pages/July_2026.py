...
st.markdown("""
    ...
    <h3 style='text-align: center; margin-top: 5px; font-weight: normal;'>(July 2025 vs July 2026)</h3>
...
def load_data():
    sales_26 = pd.read_excel('2026_July/B_Inv_MPUAE-Jul2026.xlsx', engine='calamine')
...
st.download_button(
    ...
    file_name="2026-JUL_MPUE-Sales_Quotes_Summary.xlsx",
